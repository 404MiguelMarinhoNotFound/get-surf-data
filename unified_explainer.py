...
_PRACTICAL_STATUS = {
    ...
    "energy": {
        ...
        "caution": "Weak & patchy",
        "poor": "Dead flat 💤",
        "unknown": "No energy data",
    },
    "wind": {
        "good": "Clean 🤙",
        "ok": "Manageable",
        "caution": "Getting choppy",
        "poor": "Blown out 💨",
...
_PRACTICAL_EXPLANATIONS = {
    "wave_fit": {
        "good": "Right in the zone. Should feel like home out there.",
        "ok": "Enough wave to get going — not perfect, but you'll find something.",
        "caution": "Scraping the edge of what's workable. Could go either way.",
        "poor": "Too small or too much — either way, probably not your session.",
        "unknown": "Not enough data on wave size to say.",
    },
    "energy": {
        "good": "Good period and power. Waves should drive through and give you something to work with.",
        "ok": "Some push but don't expect it to do the work for you.",
        "caution": "Power's inconsistent. Sets will feel weak or hit-and-miss.",
        "poor": "Period and power aren't there. Expect flat, mushy, forgettable waves.",
        "unknown": "Not enough data on period and power to say.",
    },
    "wind": {
        "good": "Wind's on your side — faces should stay clean and readable.",
        "ok": "Not ideal, but you'll manage. Nothing that should ruin it.",
        "caution": "Wind starting to mess with things. Timing gets harder.",
        "poor": "Wind's going to make it a mess. Hard to read, hard to time, hard to enjoy.",
        "unknown": "Not enough wind data to call.",
    },
    "shape": {
        "good": "Clean groundswell lines, not much chop. Should hold together nicely.",
        "ok": "A little textured but lines are holding. Nothing crazy.",
        "caution": "Chop or mixed swell breaking up the lines. Less predictable.",
        "poor": "Waves falling apart before they should. Hard to commit to anything out there.",
        "unknown": "Not enough shape data to call.",
    },
    "direction": {
        "good": "Swell's aimed right at the break. Should light it up.",
        "ok": "Angle's not perfect but the swell still reaches. You'll find sets.",
        "caution": "Needs to wrap to get in. Expect inconsistent sets.",
        "poor": "Wrong angle for this break. Most of the swell is going to miss.",
        "unknown": "Not enough direction data to call.",
    },
    "tide": {
        "good": "Tide's right where this break wants it. Good time to be in the water.",
        "ok": "Not the sweet spot but it'll work. Make the most of it.",
        "caution": "Tide's in an awkward place for this break. Not helping.",
        "poor": "Tide's fighting the break. Probably going to flatten or close out the shape.",
        "unknown": "No tide data for this session.",
    },
}
